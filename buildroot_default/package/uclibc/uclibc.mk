...
UCLIBC_PACKAGE_DIR = $(BASE_DIR)/packages/uclibc
...
define UCLIBC_INSTALL_TEST_SUITE
	mkdir -p $(UCLIBC_PACKAGE_DIR)/root/uClibc
	cp -rdpf $(@D)/test $(UCLIBC_PACKAGE_DIR)/root/uClibc
	$(INSTALL) -D -m 0644 $(@D)/Rules.mak $(UCLIBC_PACKAGE_DIR)/root/uClibc/Rules.mak
	$(INSTALL) -D -m 0644 $(@D)/.config $(UCLIBC_PACKAGE_DIR)/root/uClibc/.config
endef
endif
